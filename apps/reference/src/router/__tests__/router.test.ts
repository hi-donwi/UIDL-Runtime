...
import { resolveConsoleModuleRoute } from "@uidl-runtime/templates/console/moduleRuntime";
import { shoeCompany } from "@uidl-runtime/templates/console/companies/shoeCompany";
